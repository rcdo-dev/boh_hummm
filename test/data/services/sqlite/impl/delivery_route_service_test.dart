...
import '../../../../../testing/data/services/sqlite/impl/delivery_route_service.dart';
...
void main() {
  ...
  final deliveryRouteService = DeliveryRouteService(connection: connection);

  test('Must insert the data of a DeliveryRoute object into the database',
      () async {
    final result = await deliveryRouteService.create(data: deliveryRouteTwo);
